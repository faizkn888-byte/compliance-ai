...
# =============================================================================
# ========== PATCH: Add these sections to your existing main.py ==========
# =============================================================================

# 1. ADD THIS IMPORT (after existing imports, before app creation)
import re

# 2. REPLACE your existing app = FastAPI(...) with this (version bump only):
app = FastAPI(
    title="Compliance AI API",
    version="0.5.0",  # BUMPED from 0.4.1
    description="AI-powered compliance with actionable implementation guidance"
)

# 3. ADD THIS ENTIRE BLOCK after your existing REGULATIONS dict and before HELPERS
...
# 4. ADD THESE FUNCTIONS after your existing helpers (before the auth routes section)
...
def analyze_document(
    ...
    return {
        ...
        "passed": passed,
        "regulation_type": regulation_type,
        "tech_stack": detect_tech_stack(text),        # <-- ADD
        "dark_patterns": detect_dark_patterns(text),  # <-- ADD
    }
...
@app.get("/health")
def health_check():
    return {"status": "ok", "version": "0.5.0"}  # Bumped version
